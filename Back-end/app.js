...
app.use(cors())
mongoose.connect('mongodb+srv://eyyunnisaisrinivasapradeep:SDny42K2o1gWkiHt@cluster0.kjaydow.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0',{useNewUrlParser: true,
...
const transporter = nodemailer.createTransport({
    ...
    secure:false,
    auth: {
        user: 'eyyunnisaisrinivasapradeep@gmail.com',
        pass: 'tONY_ES04'
    }
});
...
app.post('/adduser',async(req,res)=>{
    ...
    const maildata={
        from:'eyyunnisaisrinivasapradeep@gmail.com',
        to:email,
...
app.post('/addtrainer',async(req,res)=>{
    ...
    const maildata={
        ...
        to:email,
        subject:"Registraion to Attendance Management Website",
        text:"Thanks for registering to Attendance Website",
        html:`<h1>Welcome Mr ${name}</h1>
        <header align="center">Thank's for registering to our website</header>
        <p>For further detai    ls click this link.....</p>
        <a href='www.aec.edu.in'>details</a>`
    };
        await data.save();
        await logindata.save();
...
app.put('/start-attendence', async (req,res) => {
    // console.log(req.body);
    const tid=req.body._id;
