  ...
  const verify=()=>{
    ...
    return(
      ...
      <MDBCol col='10' md='6'>
        ...
        <input  className='col-8 w-75 ml-5' id='email' name='email'type='email' value={formdata.email} size="md" onChange={(e)=>setFormdata({...formdata,email:e.target.value})}/><br/><br/>
        <button className='col-2 btn btn-primary ml-5' onClick={verify}> send</button>
        </div>
